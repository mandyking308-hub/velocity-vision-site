...
const routes = [
  ...
  },
  {
    ...
    desc: "Terms, privacy, data processing, security and compliance questions.",
  ...
  },
  {
    ...
    desc: "Integration partners, resellers, embedded use cases.",
...
const Contact = () => {
  ...
  const scrollToContactForm = (topic?: string) => {
    if (topic) {
      setForm((current) => ({ ...current, topic }));
    }

    const targetHash = "#contact-form";
    ...
    window.requestAnimationFrame(() => {
      ...
      const firstField = target?.querySelector<HTMLInputElement>('input[name="name"]');
      ...
      <main className="pt-20">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-primary-foreground/70 text-lg max-w-2xl">
                Most people don't need a demo to get started — the workspace is self-serve. Pick the route that matches what you need.
              </p>
              <p className="text-primary-foreground/60 text-sm max-w-2xl mt-3">
                Velocity Vision supports international founders, teams and agencies. Choose the route that matches your enquiry and we'll direct it internally.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="section-padding bg-background">
          <div className="max-w-7xl mx-auto">
            ...
            <div id="contact-form" className="grid grid-cols-1 lg:grid-cols-2 gap-16 scroll-mt-24">
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  />
                  <div>
                    <label htmlFor="contact-topic" className="block text-xs font-medium text-muted-foreground mb-1">
                      Topic
                    </label>
                    <select
                      id="contact-topic"
                  ...
                  <p className="text-xs text-muted-foreground">
                    Your information is used to respond to this enquiry as described in the{" "}
                    <Link
              ...
              >
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="font-display font-semibold text-foreground">Operating entity</h3>
                  </div>
                  <div className="space-y-1 text-sm text-muted-foreground">
                    ...
                    <p>
                      Support and billing:{" "}
                      <a
                        href="mailto:contact@velocity-outreach.com"
                ...
                <div className="bg-card border border-border/50 rounded-xl p-6 shadow-card">
                  ...
                  <p className="text-muted-foreground text-sm mb-4">
                    For larger workspaces, agency usage or custom billing questions, send a message and we'll route it internally.
                  </p>
                  <Button
                    variant="cta"
                    size="default"
                    type="button"
                    onClick={() => scrollToContactForm("enterprise_volume")}
                  >
                    Send a volume enquiry
                  </Button>
                </div>
              </motion.div>
            </div>
