...
const Insights = () => (
  <>
    <SEO
      ...
      description="Playbooks on activation, data quality, follow-up, cadence, and pipeline discipline — from a product built to run commercial workflows."
      path="/insights"
      jsonLd={{
      ...
      <section className="section-padding bg-hero">
        <div className="max-w-7xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <p className="text-primary-foreground/70 text-lg max-w-2xl">Activation, data quality, follow-up, cadence, and pipeline discipline — written from a product built to run real commercial workflows.</p>
          </motion.div>
        </div>
      </section>
