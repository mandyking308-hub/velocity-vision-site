...
const topics = [
  ...
  { icon: Upload, title: "Upload authorised data", body: "Use CSV or spreadsheet upload only for business records your organisation is authorised to process. Workspace quality flags support customer review and do not establish lawful basis, recipient suitability, deliverability or compliance." },
  ...
  { icon: TrendingUp, title: "Choose the right paid service level", body: "Starter is £149 one-off with 30 days and a normal 20/day send ceiling. Growth is £249/month with recurring cadence and 50/day. Agency is £499/month with isolated client workspaces, pooled credits and a 100/day normal ceiling." },
