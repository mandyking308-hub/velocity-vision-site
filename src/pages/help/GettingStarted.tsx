...
const topics = [
  ...
  { icon: ShieldCheck, title: "Review and approve the campaign", body: "Check factual accuracy, claims, recipients, tone and applicable legal requirements. Record human approval before activation preparation. Human approval remains the customer's responsibility." },
  ...
  { icon: Share2, title: "Publish social posts via Buffer", body: "On an eligible paid plan, optionally connect your own Buffer account in Settings, then open a reviewed campaign post and choose Send to Buffer. You pick the channel and whether it goes as a draft, to the queue, or on a schedule — publishing stays under your control in Buffer, and Velocity never posts automatically. Free Preview keeps social content in review mode inside Velocity. Supported channels depend on the channels connected in your Buffer account." },
