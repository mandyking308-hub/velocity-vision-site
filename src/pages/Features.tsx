...
const groups = [
  ...
  { label: "Billing and top-ups", features: [
...
export default function Features() {
  return <>
    ...
    <main className="pt-24">
      ...
      <section className="section-padding bg-hero text-center"><div className="max-w-3xl mx-auto"><h2 className="text-3xl md:text-5xl font-display font-bold text-primary-foreground mb-5">Review the exact service level before purchase</h2><p className="text-primary-foreground/75 text-lg mb-8">Pricing shows the current plan limits, Campaign Credits, billing cadence and sending ceilings.</p><Button variant="hero" size="lg" asChild><Link to="/pricing">See pricing <ArrowRight size={18} /></Link></Button></div></section>
    </main>
