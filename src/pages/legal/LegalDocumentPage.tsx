    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          `Customers must not share credentials, permit unauthorised access, bypass security controls, use another person’s account, create misleading user identities or allow unapproved users to access workspaces.`,
        ],
        bullets: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          `Workspace separation is intended to reduce unauthorised access between customers, clients and workspaces.`,
      ...
      },
      {
        ...
        paragraphs: [
          `Customer is responsible for preventing, detecting and responding to business email compromise, impersonation, invoice fraud, social engineering, phishing, credential theft, unauthorised sender use and internal misuse affecting Customer’s users, senders, devices, accounts, clients or integrations.`,
          `Velocity Vision is not responsible for losses caused by customer-side business email compromise, fake instructions, compromised accounts, unauthorised payment instructions, user deception, client impersonation, provider impersonation or social engineering unless directly caused by our breach of this Platform Security Policy.`,
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          `unauthorised access can never occur`,
      ...
      },
      {
        ...
        bullets: [
          ...
          `it will not conduct unauthorised testing`,
