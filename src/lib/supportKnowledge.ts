...
export const KNOWLEDGE: KnowledgeEntry[] = [
  ...
  },
  {
    ...
    answer: "Use Campaigns → New or the First-Campaign Copilot. A full campaign pack is a credit-priced AI action. Cadence dates organise recurring work on eligible plans but do not send automatically; each run remains customer-controlled.",
