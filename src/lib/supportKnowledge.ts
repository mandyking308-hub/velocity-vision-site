...
export const KNOWLEDGE: KnowledgeEntry[] = [
  ...
  },
  {
    ...
    answer: "Live mailbox connection and sender verification are paid-plan activation features. Free Preview does not connect a live mailbox or send. On Starter, Growth or Agency, use Email Settings as the authoritative status page: a connected mailbox may still be warming up, waiting for DNS checks or otherwise unavailable for customer sending. Do not share passwords, API keys, client secrets or app passwords in support messages.",
