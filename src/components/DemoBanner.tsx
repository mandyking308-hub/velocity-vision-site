  ...
  return (
    <div className="bg-accent text-accent-foreground px-4 py-2.5 flex items-center justify-between gap-4 text-sm z-50 sticky top-0">
      <p className="flex-1 text-center font-medium">
        🎯 You are currently viewing the <span className="font-bold">Velocity Influence Demo Environment</span>. Data shown here is sample data for demonstration purposes.
      </p>
