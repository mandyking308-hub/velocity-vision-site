...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "notice.subject": "Velocity Vision account update",
  },
  es: {
    "welcome.subject": "Bienvenido a Velocity Vision",
    "welcome.body": "Hola {{name}}, tu espacio está activo. Sube tu primera audiencia para lanzar una campaña en minutos.",
    "receipt.subject": "Tu recibo de Velocity Vision",
    ...
    "notice.subject": "Actualización de tu cuenta Velocity Vision",
  },
  fr: {
    "welcome.subject": "Bienvenue sur Velocity Vision",
    ...
    "receipt.subject": "Votre reçu Velocity Vision",
    ...
    "notice.subject": "Mise à jour de votre compte Velocity Vision",
  },
};
